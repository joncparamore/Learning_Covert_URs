...
#learned phonotactic_weights from phonotactic learning stage
...
def candidates(inpair):
    ...
    #defining fully faithful candidate (straightforward for punjabi data since no deletion, insertion, etc.) 
    #This is where the correspondence relations between UR and SR are generated.
...
def objective(parameters):
    ...
    #assign the list of (tag, PotentUR) tuples to a variabe
        ...
        for stem in URprobs_Normalized[stemtag]:
            ...
            for suf in URprobs_Normalized[suftag]:
                ...
                if surface_form in prob_stem_suf_input_pair:
                    ...
                    #likelihood of the surfaceform given the current UR probabilities and the probability of the surfaceform winning
...
def gradient(parameters):
    global gradient_iteration  # Access the global variable for counting optimization iteration number during processing
...
concrete_weights = [3.36, 99.96, 5.65, 100.00, 0.20, 100.00, 100.00, 0.00, 100.00]